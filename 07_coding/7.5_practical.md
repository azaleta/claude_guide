## 7.5 自主编码实践与案例 (Agentic Coding in Action)
...
### 7.5.1 案例一：全栈功能即刻实现 (Feature Implementation)
...
### 7.5.2 案例二：遗留代码的大规模重构 (Legacy Refactoring)
...
### 7.5.3 案例三：从零构建测试套件 (Test Generation)
