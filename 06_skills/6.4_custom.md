## 6.4 创建自定义 Skills (Building Custom Skills)
...
现在，已经掌握了创建单一 Skill 的能力。但在真实世界中，复杂任务往往需要多个专家协作——比如一个负责写代码，一个负责写文档，一个负责做测试。这就涉到了 **Skill Orchestration (技能编排)**。
